  ...
  return (
    <PageWithSidebarAds>
      <div className={styles.container}>
        ...
        <p className={styles.paragraph}>{t('connect.intro1')}</p>
        <p className={styles.paragraph}>{t('connect.intro2')}</p>
        ...
        <p className={styles.paragraph}>{t('connect.afterText')}</p>

        <h2 className={styles.subtitle}>{t('connect.removeTitle')}</h2>
        <p className={styles.paragraph}>{t('connect.removeText')}</p>
        <p className={styles.paragraph}>{t('connect.conclusion')}</p>
      </div>
    </PageWithSidebarAds>
  );
};
